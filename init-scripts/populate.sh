...
#aws dynamodb --endpoint-url=http://127.0.0.1:8042 create-table \
...
aws --endpoint-url=http://10.11.0.3:8000 dynamodb put-item --table-name users --item '{"userId": {"S": "'d8632d18-6286-4a7c-8ff7-5679a65234f6'"}, "username": {"S": "user2"}, "password": {"S": "123321"}, "fullname": {"S": "Jane Smith"}, "email": {"S": "user2@example.com"}}'
